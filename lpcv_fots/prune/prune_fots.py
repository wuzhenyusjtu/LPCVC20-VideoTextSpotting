...
if __name__ == '__main__':
    ...
    parser.add_argument('--batches-before-train', type=int, default=2,
                        help='Number of batches to process before train step')
    ...
    configure_list = [{
        ...
        'op_types': ['Conv2d'],
        'op_names': [
            'resnet.conv1', 'resnet.layer1.0.conv1', 'resnet.layer1.0.conv2', 'resnet.layer1.1.conv1',
            'resnet.layer1.1.conv2', 'resnet.layer1.2.conv1', 'resnet.layer1.2.conv2', 'resnet.layer2.0.conv1',
            'resnet.layer2.0.conv2', 'resnet.layer2.0.downsample.0', 'resnet.layer2.1.conv1', 'resnet.layer2.1.conv2',
            'resnet.layer2.2.conv1', 'resnet.layer2.2.conv2', 'resnet.layer2.3.conv1', 'resnet.layer2.3.conv2',
            'resnet.layer3.0.conv1', 'resnet.layer3.0.conv2', 'resnet.layer3.0.downsample.0', 'resnet.layer3.1.conv1',
            'resnet.layer3.1.conv2', 'resnet.layer3.2.conv1', 'resnet.layer3.2.conv2', 'resnet.layer3.3.conv1',
            'resnet.layer3.3.conv2',  'resnet.layer3.4.conv1', 'resnet.layer3.4.conv2', 'resnet.layer3.5.conv1',
            'resnet.layer3.5.conv2', 'resnet.layer4.0.conv1', 'resnet.layer4.0.conv2', 'resnet.layer4.0.downsample.0',
            'resnet.layer4.1.conv1', 'resnet.layer4.1.conv2', 'resnet.layer4.2.conv1', 'resnet.layer4.2.conv2',
            'center.0.0', 'center.1.0', 'decoder4.squeeze.0', 'decoder3.squeeze.0', 'decoder2.squeeze.0',
            'decoder1.squeeze.0',
            ]
    }]
    ...
    for epoch in range(args.epochs):
        ...
        val_loss = train_one_epoch(model, detection_loss, optimizer, lr_scheduler, max_batches_per_iter_cnt, dl, dl_val,
                                   epoch)
        pruner.export_model(model_path='{}/pruned_fots{}.pth'.format(output_path, epoch),
                            mask_path='{}/mask_fots{}.pth'.format(output_path, epoch))
